...
<body>
  <h5 style="margin-left: 50px; margin-top: 50px;">Employee Add</h5>
  <div class="content">
    <form style="margin-left: 50px; margin-top: 50px;" method="post" action="/employee">
    {{csrf_field()}}
      <div class="form-row">
      ...
      <div class="form-row">
        <div class="form-group col-md-4">
          ...
          <input type="name" class="form-control" id="last_name" placeholder="First Name">
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-4">
